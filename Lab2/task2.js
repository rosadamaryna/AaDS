/*Дано покажчики Px і Py на два різних елементи двозв'язного списку;
елемент з адресом Px знаходиться у списку поперед елемента з адресом Py,
але не обов'язково поряд з ним. Перемістити елементи, які знаходяться поміж даними елементами 
(не долучаючи дані елементи) у новий список (в тому самому порядку). 
Вивести покажчик на перші елементи перетвореного та нового списків. 
Якщо новий список стане порожнім, то пов'язаний з ним покажчик буде дорівнювати null.*/ 
